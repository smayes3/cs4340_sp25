...
export interface MermaidConfig {
  ...
  activity?: ActivityDiagramConfig;
...
/**
 * The object containing configurations specific for Activity diagrams.
 *
 * This interface was referenced by `MermaidConfig`'s JSON-Schema
 * via the `definition` "ActivityDiagramConfig".
 */
export interface ActivityDiagramConfig extends BaseDiagramConfig {
  /**
   * Margin top for the text over the diagram
   */
  titleTopMargin?: number;
